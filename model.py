...
class CartItems(db.Model):
    ...
    sneaker_id = db.Column(db.Integer, db.ForeignKey('sneakers.id'), nullable=False)  # Establishing the relationship
    sneaker = db.relationship('Sneakers', backref='cart_items')

    def __init__(self, cart_id, sneaker_id, product_name, product_price, quantity, subtotal):
        '''
