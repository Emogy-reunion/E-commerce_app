...
class SearchForm(FlaskForm):
    ...
    min_price = FloatField('Minimum price', validators=[Optional(), NumberRange(min=0, message="Minimum price must be greater than or equal to 0")])
...
class CheckoutForm(FlaskForm):
    ...
    '''
    shipping_address =  StringField('Pickup location', validators=[InputRequired(),Length(min=4, max=45, message="Must be at least 3 characters long and not more than 45.")])
